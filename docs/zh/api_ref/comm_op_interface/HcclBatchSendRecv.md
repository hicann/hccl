...
| 参数名 | 输入/输出 | 描述 |
| --- | --- | --- |
| sendRecvInfo | 输入 | 本rank需要下发的收发任务列表的首地址。<br>HcclSendRecvItem类型，详细可参见[HcclSendRecvItem](https://gitcode.com/cann/hcomm/blob/9.2.0/docs/zh/api_ref/comm_mgr_c/data_type_definition/HcclSendRecvItem.md)。|
