...
针对Atlas A3系列产品，在CANN日志中存在关键字“RanktableCheck”，如下所示：
...
在rank table文件中补充"super_device_id"字段，配置说明可参考[rank table配置资源信息（Atlas A3系列产品）](../cluster_info_config/rank_table_config_a3.md)。
