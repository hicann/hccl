...
REGISTER_EXEC_V2(
    ...
    CcuTempAlltoAllVMesh1D);
REGISTER_ALG_ATTRS(
    CcuSchedAllToAllVSoleMeshMultiJetty, topo.supportLevel0Topos = LEVEL0_TOPO_MESH_1D_CLOS;
    topo.maxTopoLevelNum = TOPO_LEVEL_NUM_2; op.unsupportedDataTypes = UNSUPPORTED_INT8_AND_64BIT;
