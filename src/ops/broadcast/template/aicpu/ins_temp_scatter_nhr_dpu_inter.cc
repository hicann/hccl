...
namespace ops_hccl {
InsTempScatterNHRDPUInter::InsTempScatterNHRDPUInter(const OpParam &param,
...
HcclResult InsTempScatterNHRDPUInter::CalcRes(HcclComm comm, const OpParam &param,
...
HcclResult InsTempScatterNHRDPUInter::GetStepInfo(u32 step, u32 nSteps, AicpuNHRStepInfo &stepInfo)
{
    ...
    if (deltaRoot < nRanks) { // 需要发
        ...
        HCCL_INFO("[InsTempScatterNHRDPUInter][GetStepInfo] rankSize[%u], myAlgRank[%d], sendTo Idx[%u]",
        ...
        HCCL_INFO("[InsTempScatterNHRDPUInter][GetStepInfo] Need to Recv: deltaRoot[%u], nRanks[%d], deltaRankPair[%d]",
        ...
        HCCL_INFO("[InsTempScatterNHRDPUInter][GetStepInfo] rankSize[%u], myAlgRank[%d], recvFrom Idx[%u]",
    ...
    const OpParam &param, const TemplateDataParams &tempAlgParams, TemplateResource &templateResource)
{
    ...
    HCCL_INFO("[InsTempScatterNHRDPUInter] queNum_ =  [%d], threads size = [%d]", threadNum_,
