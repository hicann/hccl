...
protected:
    ...
    void GenTempAlgParamsRSL1(const u64 loop, const u64 currDataCount, const u64 sliceSizeRSL0, const u64 tailSizeRSL0,
        TemplateDataParams &tempAlgParamsRSL1) const;
    void GenTempAlgParamsRSL2(const u64 loop, const u64 currDataCount, const u64 sliceSizeRSL1, const u64 tailSizeRSL1,
        TemplateDataParams &tempAlgParamsRSL2) const;
    void GenTempAlgParamsAGL2(const u64 loop, const u64 currDataCount, const u64 sliceSizeRSL2, const u64 tailSizeRSL2,
