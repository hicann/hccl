    ...
    AlgResourceRequest& resourceRequest)
{
    ...
    HCCL_DEBUG(
        "[CcuTempReduceScatterVMesh1DMem2Mem::CalcRes] notifyNumOnMainThread[%u] slaveThreadNum[%u]",
    ...
    HCCL_DEBUG(
        "[CcuTempReduceScatterVMesh1DMem2Mem::CalcRes] channelDescs.size()=%llu, dimsize=%llu, "
