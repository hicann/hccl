...
protected:
    ...
    HcclResult BuildSubCommRanks(const AlgHierarchyInfoForAllLevel& algHierarchyInfo);
    HcclResult InitRankInfo(const OpParam& param);
    void InitTemplates(const OpParam& param);
