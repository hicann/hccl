...
add_library(scatter_aicpu_kernel SHARED
    ...
    ${CMAKE_CURRENT_SOURCE_DIR}/ops/op_common/template/aicpu/task_cache/aicpu_task_cache_policy.cc
    ...
    ${CMAKE_CURRENT_SOURCE_DIR}/ops/op_common/topo/topo_match_concurrent.cc
...
if(NOT HCCL_CANN_COMPAT_850)
    target_sources(scatter_aicpu_kernel PRIVATE
        ...
        ${CMAKE_CURRENT_SOURCE_DIR}/ops/op_common/topo/topo_match_base_v2.cc
        ${CMAKE_CURRENT_SOURCE_DIR}/ops/op_common/topo/topo_match_one_level.cc
        ${CMAKE_CURRENT_SOURCE_DIR}/ops/op_common/topo/topo_match_two_level.cc
        ${CMAKE_CURRENT_SOURCE_DIR}/ops/op_common/topo/topo_match_three_level.cc
        ${CMAKE_CURRENT_SOURCE_DIR}/ops/op_common/topo/topo_match_concurrent_v2.cc
        ...
        ${CMAKE_CURRENT_SOURCE_DIR}/ops/broadcast/executor/ins_v2_broadcast_sequence_executor_aicpu_3level.cc
        ...
        ${CMAKE_CURRENT_SOURCE_DIR}/ops/broadcast/executor/ins_v2_broadcast_concurrent_executor.cc
    )
endif()
