...
#ifndef REDUCE_SCATTER_AICPU_TESTCASE_COMMON_H
#define REDUCE_SCATTER_AICPU_TESTCASE_COMMON_H
...
static inline u32 CalsRankSize(const TopoMeta& topoMeta)
{
    u32 rankSize = 0;
...
static inline void RunReduceScatterAicpuA5(
...
#endif // REDUCE_SCATTER_AICPU_TESTCASE_COMMON_H
